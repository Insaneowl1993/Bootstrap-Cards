[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=13264342&assignment_repo_type=AssignmentRepo)
<br/>
<br/>
...
1.) Update the index.html file with the Bootstrap application.

2.) Responsiveness should be as follows:

- 4 cards per row on large screens (and above),
- 2 cards per row on medium screens, and
- 1 card per row on small screens (and below).
